...
async function main() {
  ...
  let amount = ethers.utils.parseUnits("1.5", 6);
  let amount1 = ethers.utils.parseUnits("1.95", 6);
  let override = {
    value: amount
  }

  let pathx = ethers.utils.defaultAbiCoder.encode([ "uint256", "address"], [ amount1, usdt_address]);
