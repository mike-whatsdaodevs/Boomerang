...
async function main() {
  ...
  let retro_quoterv2 = process.env.P_RETOR_QUOTER;
  ...
  for(let k = 0; k< tokens.length; ++ k) {
      ...
      let tokenIn = wmatic_address;
      let tokenOut = tokens[k];
      let tokenIn_decimal = 18;
      ...
      for(let i = 0; i < fees.length; i ++) {
        ...
        // console.log("RETRO V3 fee : ", i);
        // let result_b2 = await poolsPrice.callStatic.getExactInAmountOut(retro_quoterv2, path_b, amountBuy);
        // console.log("buy ", ethers.utils.formatUnits(result_b2.expectedAmount.toString(), tokenIn_decimal));

        // let result_s2 = await poolsPrice.callStatic.getExactInAmountOut(retro_quoterv2, path_s, amountSell);
        // console.log("sell ", ethers.utils.formatUnits(result_s2.expectedAmount.toString(), tokenOut_decimal));
      }
      console.log("-----------------------");
  }
